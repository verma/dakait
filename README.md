...
Current Release
---
Current release version is `0.0.1`.  It will do what its supposed to do, but it has a long way to go.

[Download Now](https://github.com/verma/dakait/releases/download/0.0.1/dakait-0.0.1-standalone.jar)
...
Once you have the jar file, make sure your server has a recent enough version of java.  You can start the server by running the following command
    ...
    java -jar dakait-0.0.1-standalone.jar
